...
Scénario: Saisie des informations du contrat
	...
	Quand je renseigne la date "15/01/2020" dans le champ "Date de signature"
	Quand je renseigne la date "20/01/2020" dans le champ "Début du contrat"
	Quand je clique sur le texte "12 mois"
	Quand je clique sur "Enregistrer"
	Alors je vois "Du 20/01/2020 au 20/01/2021 - (environ 1 an)"
